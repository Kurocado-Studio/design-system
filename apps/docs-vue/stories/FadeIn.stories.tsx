  ...
  render: (args) => ({
    ...
    template: `
      <FadeInStaggerGroup v-bind="args" :tag="Grid" :columns="{ sm: '1', md: '2' }" gap="8" justify="center" class="max-w-7xl">
        <FadeIn :tag="Typography" :staggerOrder="0" fadeInDirection="UP" :size="{ base: 'sm', md: 'lg', lg: '9xl' }">
          Item 1: UP
        </FadeIn>
        <FadeIn :tag="Typography" :staggerOrder="1" fadeInDirection="LEFT_TO_RIGHT">
          Item 2: LEFT_TO_RIGHT
        </FadeIn>
        <FadeIn :tag="Typography" :staggerOrder="2" fadeInDirection="RIGHT_TO_LEFT" :size="{ base: 'sm', md: 'lg', lg: '4xl' }" />
      </FadeInStaggerGroup>
    `,
  }),
};
